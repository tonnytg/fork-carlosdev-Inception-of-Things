...
echo "Start Install and Configure ArgoCD"
...
kubectl apply -f /vagrant_data/traefik-crd.yaml -n argocd
kubectl apply -f /vagrant_data/ingress.yaml -n argocd
...
echo "Finish Configure ArgoCD"

# List Apps
argocd app list

echo "Finish Install and Cofigure ArgoCD"
